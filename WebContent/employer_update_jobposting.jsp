...
<script>
	$(document).ready(function() {
		$('#btnSubmit').click(function(e) {
			var isValid = true;
			var nicInstance = nicEditors.findEditor('addresseInput');
			var address = nicInstance.getContent();
			if(address.length < 5){
				isValid = false;
				$("#errorAddress").html("Please Enter The Address Field");
			}
			else{
				$("#errorAddress").hide();
			}
			
			var nicInstance1 = nicEditors.findEditor('jobDescriptionInput');
			var address1 = nicInstance1.getContent();
			if(address1.length < 5){
				isValid = false;
				$("#errorAddress1").html("Please Enter The Job Description Field");
			}
			else{
				$("#errorAddress1").hide();
			}
			...
			var nicInstance2 = nicEditors.findEditor('keyWordsInput');
			var address2 = nicInstance2.getContent();
			if(address2.length < 5){
				isValid = false;
				$("#errorAddress2").html("Please Enter The KeySkills Field");
			}
			else{
				$("#errorAddress2").hide();
			}
			...
			<div class="row">
				...
				<div class="bg-color1 block-section line-bottom">
					...
					<form:form id="myForm" method="post" class="login-form clearfix"
						commandName="jobupdate" modelAttribute="jobupdate">
						...
						<div class="form-group">
							<div class="row clearfix">
								...
								<div class="col-xs-4">
									<label>Industry Type</label> <font style="color: red;">*
									</font>
