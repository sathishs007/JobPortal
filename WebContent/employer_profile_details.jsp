...
<body>
			<div class="box-list">
				<div class="item">
						...
						<c:if test="${!empty employerDetail}">
							<div class="resume-block">
								<div class="img-profile">
									<img
										src="employerProfileImageDisplay.html?id=${employerDetail.id}"
										alt="">
								</div>
								<div class="desc">
									<h2>
									...
									<h5><i class="fa fa-building"></i>
										...
										<span class="color-white-mute"> - <c:out
												...
												value="${employerDetail.city}"></c:out></br>
									...
									<h5>
										<p>
											Roles - <span class="richtext-word-wrap"><c:out
										...
										<h5>
											Product Enrolled- <span class="color-white-mute"> <c:out
													value="${employerDetail.productEnrolled}"></c:out></span>
										</h5>
									
									<h3 class="resume-sub-title">
										<span><i class="fa fa-history"></i> Company profile</span>
									</h3>
					...
					<br/>
					<div >
								<a href="employer_profile_view.html"> <input type="button"
