	...
	$(function() {
		...
		$("#datepicker2").datepicker({
			...
			onSelect : function(selected) {
				...
				$("#datepicker3").datepicker("option", "minDate", dt);
		...
		$("#datepicker3").datepicker({
			...
			onSelect : function(selected) {
				...
				$("#datepicker2").datepicker("option", "maxDate", dt);
	...
	<div class="box-list">
		<div class="item">
			<div class="row">
				...
				<h3 class="text-center no-margin titleunderline">Walkin Job
					Post</h3>
				<hr />
				<div class="bg-color1 block-section line-bottom">
					...
					<form:form id="myForm" method="post" class="login-form clearfix"
						action="walkin_profile_creation.html" commandName="walkinBO">
							...
							<div class="row clearfix">
								<div class="col-xs-6">
									...
									<form:input type="text" class="form-control" path="startDate"
										id="datepicker2" placeholder="Start Date"
								...
								<div class="col-xs-6">
									...
									<form:input type="text" class="form-control" path="endDate"
										id="datepicker3" placeholder="End Date"
										data-date-format="yyyy/mm/dd" />
									<div class="color-white-mute">
										<small>mm/dd/yyyy</small>
									</div>
						...
						<div class="form-group">
							<div class="row clearfix">
								...
								<div class="col-xs-4">
									<label>PG Qualification</label> <font style="color: red;">
									</font>
						...
						<div class="form-group ">
							<input type="submit" value="Walkin Post" id="btnSubmit"
