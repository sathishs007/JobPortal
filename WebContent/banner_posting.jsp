	...
	<div class="box-list">
		<div class="item">
			<div class="row">
				...
				<h3 class="text-center no-margin titleunderline">Banner Post</h3>
				<hr>
				<div class="warning"
				...
				<form:form id="myForm" method="post" class="login-form clearfix"
					commandName="bannerpost" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>Post Page Type</label> <font style="color: red;">* </font>
					...
					<div class="form-group">
						...
						<form:select id="noMonthInput" name="totalMonth" path="totalMonth"
							class="form-control">
					...
					<div class="form-group ">
						<input type="submit" value="Post Banner"
							...
							href="renewal_bannerList.html"> <input type="button"
