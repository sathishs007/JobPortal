...
<body>
	<div class="box-list">
		<div class="item">
			<div class="row">
			<h3 class="text-center no-margin titleunderline">Feedback Details</h3>
				<hr />
			<c:if test="${!empty viewfeedbackdetail}">
			<div class="pi-responsive-table-sm">
								<table style="border: 1px solid;">
									...
									<td><c:out value="${viewfeedbackdetail.name}"></c:out></td>
									</tr>
									<tr>
									<td style="padding-left:50px;width:200px;"> <label class="color-white-mute list-capitalize "> Phone Number </label></td>
									<td>:</td>
									<td><c:out value="${viewfeedbackdetail.phoneno}"></c:out></td>
									</tr>
									<tr>
									<td style="padding-left:50px;width:200px;"> <label class="color-white-mute list-capitalize "> Email </label></td>
										<td class="color-white-mute list-capitalize ">:</td>
									<td><c:out value="${viewfeedbackdetail.email}"></c:out></td>
									</tr>
									<tr>
									<td style="padding-left:50px;width:200px;"> <label class="color-white-mute list-capitalize "> Subject </label></td>
							<td class="color-white-mute list-capitalize ">:</td>
									<td><c:out value="${viewfeedbackdetail.subject}"></c:out></td>
									</tr>
									<tr>
									<td style="padding-left:50px;width:200px;"> <label class="color-white-mute list-capitalize ">  Area of Concern  </label></td>
								<td class="color-white-mute list-capitalize ">:</td>
									<td><c:out value="${viewfeedbackdetail.area}"></c:out></td>
									</tr>
									<tr style="vertical-align:top;">
									<td style="padding-left:50px;"> <label class="color-white-mute list-capitalize "> Details of Concern </label></td>								
									<td class="color-white-mute list-capitalize ">:</td>
									<td style="padding-right:50px;"><p><c:out value="${viewfeedbackdetail.details}" escapeXml="false"></c:out></p>
									</td>
									</tr>
									</tbody>
								</table>
			...
			<div class="box-list">
						<a href="view_feedback.html"    style="margin-left:450px;"> <input type="button"
