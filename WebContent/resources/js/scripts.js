...
function init_map()
{
  ...
  var image = 'resources/images/gmap_default.png';
...
$(function()
{
	...
	$('#quick-search-switcher').on('click', function()
	{
	 ...
	 var docs1 = [
	        	 { value: ' Blood', data: 'staff-page.html' },
	        	 { value: 'Acne', data: 'staff-page.html' },
	        	 { value: 'Acupuncture', data: 'staff-page.html' },
	        	 { value: 'Cardiology', data: 'staff-page.html' },
	        	 { value: 'Alcohol And Teens', data: 'staff-page.html' },
	        	 { value: 'Allergy', data: 'staff-page.html' },
	        	 { value: 'Eye Checkup', data: 'staff-page.html' },
	        	 { value: 'Urinalysis', data: 'staff-page.html' }];   
	 
	 var docs2 = [
		        	 { value: ' Chennai', data: 'staff-page.html' },
		        	 { value: 'Bangalore', data: 'staff-page.html' },
		        	 { value: 'Mumbai', data: 'staff-page.html' },
		        	 { value: 'Hydrabad', data: 'staff-page.html' },
		        	 { value: 'Pune', data: 'staff-page.html' },
		        	 { value: 'Trichy', data: 'staff-page.html' },
		        	 { value: 'Coimbathore', data: 'staff-page.html' }];    
	...
	$('#news').on('click', '.more', function()
	{
		...
		$.get('ajax/' + template + page + '.jsp').done(function(data)
		{
			$('#news .grid').isotope('insert', $(data));
			loader.data('page', ++page);
			
			$.get('ajax/' + template + page + '.jsp').fail(function()
			{
