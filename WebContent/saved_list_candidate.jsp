...
<body>
	<div class="box-list">
		<div class="item">
				...
				<c:if test="${!empty candidateview}">
					<div class="resume-block">
						<div class="img-profile" style="top: -40px;">
							...
							<%-- <img src="showjobseekerimage.html?id=${candidateview.profileId}" alt=""> --%>
							<img src="imageLoginDisplay.html?id=${candidateview.profileId}" alt="">
						</div>
						<div class="desc">
							<h2>
			...
			<div class="box-list">
				<a href="admin_employer_history.html"> <input type="button"
