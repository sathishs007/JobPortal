	...
	<div class="box-list">
		<div class="item">
			<div class="row">
				...
				<h3 class="text-center no-margin">FeedBack</h3>
				<hr />
				...
				<div class="row">
					<form:form id="myForm" method="post" class="form-search-list"
						action="feedbackSearch.html" commandName="feedbackSearch">
				...
				<div class="pi-section-w pi-section-white piTooltips">
						<display:table id="feedback" name="${feedbackList}"
							requestURI="view_feedback.html" pagesize="5" export="false"
							class="pi-table pi-table-complex pi-table-hovered pi-round pi-table-shadow pi-table-all-borders">
							<display:column property="sno" title="SNo" />
							<display:column property="name" title="Name" />
							<display:column property="email" title="Email" />
							<display:column property="phoneno" title="Phone Number" />
							<display:column property="feedbackCreateDate" title="Created" />
							
							<display:column url="view_feedback_details.html"
								media="html" paramId="id" paramProperty="id"
								title="View">
								<a
									href="view_feedback_details.html?id=${feedback.id}"><i
									style="text-align: center;" class="fa fa-search"></i></a>
							</display:column>
							
							 <display:column url="view_feedback_delete.html"
								media="html" paramId="id" paramProperty="id"
								title="Delete">
								<a
									href="view_feedback_delete.html?id=${feedback.id}"
