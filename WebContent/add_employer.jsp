				...
				<div class="item">
					<div class="row">
						<div class="text-center">
							...
							<h3 class="text-center no-margin titleunderline">Create Employer</h3>
				         <hr />
						</div>
						...
						<!-- form login -->
						<form:form id="myForm"  action="add_employer.html" method="post" class="login-form clearfix"
								...
								<div class="row clearfix">
									...
									<div class="col-xs-6">
										...
										<form:input type="text" class="form-control"
											...
											placeholder="Confirm EmailAddress" maxlength="50"/>
							...
							<%--  <div class="form-group">
								...
								<form:input type="text" class="form-control" path="companyName"
									id="companyNameInput" placeholder="Company Name" maxlength="50"/>
				          ...
				          <input type="button" id="otherCompany" value="Other Names" 
							...
							<div class="form-group">
								...
								<form:input type="text" class="form-control" path="webSite"
									id="webSiteInput" placeholder="Website" maxlength="75" />
