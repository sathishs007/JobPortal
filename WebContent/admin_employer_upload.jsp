			...
			<div class="item">
				<div class="row">
					<div class="col-sm-12 col-md-12 col-xs-12 col-lg-12"
						...
						<form:form id="productCreation" modelAttribute="employerUpload"
							commandName="employerUpload" enctype="multipart/form-data"
							action="admin_employer_upload.html" method="POST">
							<div class="form-group">
								<div class="row clearfix">
									<div class="col-xs-6">
										<label>Upload Files</label> <input type="file"
											name="uploadEmployer" path="uploadEmployer" onchange="fileCheck(this)"
