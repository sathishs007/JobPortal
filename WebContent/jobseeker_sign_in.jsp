...
<body>
	...
	<div class="body-content clearfix">
		<div class="block-section bg-color4">
			<div class="container">
				<div class="panel panel-md" style="margin-top:20px;">
				...
				<div class="text-center color-white">
					Not a member? &nbsp; <a href="jobseeker_sign_up.html" style="text-decoration: underline;"
				...
				<div class="modal-content">
					...
					<form>
						...
						<div class="modal-body">
							<div class="form-group">
								<label>Enter Your Email</label> <input type="emails"
