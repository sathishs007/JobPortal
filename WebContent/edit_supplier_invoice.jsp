				...
				<div class="grid-mid">
					...
					<section class="widget widget-appointment ">
						<form:form id="myForm" class="login-form clearfix"
							enctype="multipart/form-data" modelAttribute="EditSupplier"
							method="POST">
						...
						<c:if test="${!empty SupplierList}">
										...
										<c:forEach items="${SupplierList}" var="searchResult">
											<tr>
												...
												<td class="text-right"><center>
														<a
															href="edit_supplier_invoice_items.html?id=${searchResult.id}&path=edit"
															class="btn btn-theme btn-xs btn-default">Edit</a>
													</center></td>
												<td class="text-right"><center>
														<a href="delete_customer.html?id=${searchResult.id}"
							...
							<div class="wpb_content_element grid-md grid-vdi">
								<a href="update_supplier_invoice.html?id=${id }"> <span
									class="wpb_button wpb_btn-rounded wpb_btn-small ">Update
										Invoice</span>
								</a>
							</div>
						</c:if>
