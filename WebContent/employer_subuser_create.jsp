	...
	<div class="container">
		<div class="col-sm-12">
			<div class="box-list">
				<div class="item">
					<div class="row">
						<h3 class="text-center no-margin titleunderline">Create
							Subuser Profile</h3>
						<hr />
						<!-- form post a job -->
						<form:form id="myForm" method="post" class="login-form clearfix"
							modelAttribute="employerSubUserBO">
								...
								<div class=" row clearfix">
									...
									<div class="col-xs-6">
										<div class="form-group " style="margin-top: 30px;">
											<button id="btnSubmit" class="btn btn-t-primary btn-theme">Submit</button>
