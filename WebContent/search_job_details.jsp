				...
				<div class="row">
					...
					<div class="col-md-3">
						<div class="block-section " id="affix-box">
							...
							<c:choose>
								<c:when test="${saveActive=='false'}">
									<a class="btn btn-theme btn-t-primary btn-block-xs">Already
										Saved</a>
									<p>
								</c:when>
								<c:otherwise>
									<p>
										<a href="save_jobs.html?id=${jobPostDetail.id}"
											class="btn btn-theme btn-t-primary btn-block-xs">Save Job</a>
									</p>
								</c:otherwise>
							</c:choose>
